...
// $mainContentMargin = $('.main-content-wrap, .backend-md-sidebar').css({ 'padding-top': $dhHeight + 15 });
...
$(document).ready(function() {
 ...
 ==================================*/
    ...
    function showMenu() {
        $('.main-navigation .has-mega-menu a, .main-navigation .menu-item-has-children').on('click', function(e) {
            e.preventDefault();
            $(this).parent('.has-mega-menu,.menu-item-has-children').toggleClass('is-show-menu');
        })
    }
